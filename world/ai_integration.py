...
from world.dm_tools import DMTools
...
class DungeonAI:
    ...
    def generate_structured_data(self, prompt: str, response_format: dict) -> dict:
        """
        Generate structured data based on a prompt and response format with deterministic seeding
        ...
        # Set options with seed if available
