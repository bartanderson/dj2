...
def auto_fix_common_errors(code: str) -> str:
    """Apply heuristics to fix frequent syntax mistakes."""
    ...
    def validate_test_imports(code: str) -> list:
        ...
        for line in code.splitlines():
            ...
            if line.startswith('from ') or line.startswith('import '):
                # Simple extraction – we only check the module part
                ...
                # Could also check "import X" but that's often standard lib
...
"""
    ...
    response = auto_fix_common_errors(response)
    ...
    for attempt in range(max_attempts):
        ...
        if not error_line:
            error_line="not found"
        correction_prompt = f"""The previous test for intent "{intent}" (target file: {target_file}) has a syntax error at line {error_line}:

{error_msg}

Here is the test code with the error:
```python
{response}
```
Please fix ONLY the syntax error. Do not change the test logic, imports, or structure. Output only the corrected Python code, no explanations.
"""
